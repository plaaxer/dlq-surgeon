...
public class ManagementClient {
    ...
    public ManagementClient(ConnectionConfig opts) throws Exception {
        this.http = new ApiHttpClient(opts, SSLManager.build(opts.tlsCa(), opts.tlsCert(), opts.tlsKey(), opts.tls()));
