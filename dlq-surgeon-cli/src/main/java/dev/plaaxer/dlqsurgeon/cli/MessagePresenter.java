...
/**
 * Renders queues and messages to the terminal.
 *
 * Extracted from MessageFetcher so that the core module stays free of
 * TUI/Console dependencies. All display concerns live here in the CLI module.
 */
