...
public class ConnectOptions {
    ...
    /** Builds a {@link ConnectionConfig} from the resolved CLI options. */
    public ConnectionConfig toConnectionConfig() {
        return new ConnectionConfig(
                host, managementPort, amqpPort, vhost, user, password,
                tls, caCertFilePath, clientCertFilePath, clientPrivateKeyPath
        );
    }
